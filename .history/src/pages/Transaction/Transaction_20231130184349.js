                ...
                <td>
                  {i.status ? (
                    ...
                    <select>
                      ...
                      <option className="complete">PENDING</option>
                      <option className="complete">FAILED</option>
                      <option className="complete">UNDER REVIEW</option>
                      <option className="complete">ON HOLD</option>
                    </select>
                  )}
                </td>
              </tr>
