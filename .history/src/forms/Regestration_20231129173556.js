        ...
        <>
          ...
          <div className="input_container special">
            ...
            >
              ...
              <input type="text" className="without_color" placeholder="Account Number" />
            </div>
            <div
            ...
            >
              <img src="./Image/11.png" alt="" />
              <input type="text" className="without_color" placeholder="Select Business Bank" />
            </div>
            <div
              className="input_group mt-3"
              style={{ width: "90%", padding: "20px" }}
            >
              <img src="./Image/11.png" alt="" />
              <input type="text" className="without_color" placeholder="Sort Code" />
            </div>
